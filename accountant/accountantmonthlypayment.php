            ...
            <li class="navihow"><a href ="accountantmonthlypayment.php"> Monthly Payment</a></li>
                ...
                <li class="navihow"><a href ="accountantbudget.php"> Budget</a></li>
                    ...
                    <div class="wrapper3">
                      <div class="sidenav3">
                          <ul>  
                              <li><a href ="#">Monthly Payment Report</a></li>
                          </ul>  
                      </div>
                    </div>
    ...
    <table class="center" border="1">
        ...
        <?php 
          ...
          if ($result->num_rows > 0) {
            ...
            echo "
            <form action='./accountant/deleteOrUpdateUser.php' method='post'>
                <tr>
                <td>".$row['driverID']."</td>
                ...
                <td>
                    ...
                    <input hidden value=". $row['driverID'] ." required type='text' name='id'>
                </td>
                <td>
