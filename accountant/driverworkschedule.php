...
<br><br><br><br><br><br>
    ...
    <div class="wrapper">
        ...
        <div class="sidenav2">
            <ul>  
                <li class="navihow"><a href ="driverworkschedule.php">Driver Workschedule</a></li>
                <li class="navihow"><a href ="#"> Live Support</a></li></a></li>
    ...
    <table class="center" border="1">
        ...
        <?php 
          ...
          if ($result->num_rows > 0) {
            ...
            echo "
            <form action='./accountant/deleteworkschedule.php' method='post'>
                <tr>
                <td>".$row['userID']."</td>
                <td>".$row['userName']."</td>
                <td>".$row['workdate']."</td>
                ...
                <button class='delete' type='submit' name='delete' onclick='return checkdelete()'>Delete</button>
                <input hidden value=". $row['userID'] ." required type='text' name='id'>
