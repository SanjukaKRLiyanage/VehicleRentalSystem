...
<table border="0" class="fulltable">
  ...
  <tr>
    <td class="tdmain" style="width:20%;"><center><br><a href="currentreservation.php" target="iframe_a"><button class="dashboad_btn">&nbsp;Current Reservation&nbsp;</button></a></center><br></td>
  </tr>
