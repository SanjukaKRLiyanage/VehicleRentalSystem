...
<header class="header">
    <nav>
      ...
      <ul class="navigation">
        ...
        <a href="dropmesignin.php"><button class="signin">Sign In</button>
        </a>  
      </div>
...
<section class="lg-container">
    ...
    <div class="login">
        <h1 class="main-title">User Sign In</h1>
        <div class="login-form">
        <form action="validatelogin.php" method="post">
            <input type="hidden" name="user_type" id="users" value="seller">
            <input required placeholder="Enter Username" type="text" name="user" id="user"/>
            <input required placeholder="Enter Password" type="password" name="pwd" id="pwd" />
            <div class="btn-div">
        ...
        <p class = "reg">Not a User Yet? <a href="usersignup.php" class = "formlink2" >Sign Up Now!</a></p>
        </div>
  </div>
